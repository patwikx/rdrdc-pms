...
export const SpaceUtilityTable: React.FC<EditableRPTTableProps> = ({ spaceId, rptDetails, onUpdate }) => {
    ...
    return (
        <Card className="shadow-sm border border-border mr-4">
            <CardHeader className="flex flex-row items-center justify-between py-4 px-6">
                <CardTitle className="text-lg font-semibold">Utility Details</CardTitle>
            ...
            <CardContent className="p-0">
                {editedRPT.length > 0 || isAdding ? (
                        ...
                        <Table className="w-full">
                            <TableHeader>
                                <TableRow className="bg-muted/50">
                                    ...
                                    <TableHead className="py-2 px-4 text-xs font-medium">Electric Bill No.</TableHead>
                                    <TableHead className="py-2 px-4 text-xs font-medium">Water Bill No.</TableHead>
                                    <TableHead className="py-2 px-4 text-xs font-medium">Due Date</TableHead>
                                    <TableHead className="py-2 px-4 text-xs font-medium">Remarks</TableHead>
                    ...
                    <div className="text-center text-muted-foreground py-8">No utility details available.</div>
                )}
            </CardContent>
        </Card>
    );

...
export const accounts = [
  {
    ...
    email: "RD Realty Development Corporation",
    icon: (
  ...
  {
    label: "RD Hardware & Fishing Supply, Inc.",
    email: "RD Hardware & Fishing Supply, Inc.",
    icon: (
      <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <title>Gmail</title>
        <path
  ...
  {
    label: "Richmond Land Innovations Inc.",
    email: "Richmond Land Innovations Inc.",
    icon: (
      <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <title>iCloud</title>
        <path
